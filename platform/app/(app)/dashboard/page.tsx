    ...
    <div className="max-w-[1400px] mx-auto space-y-8">
        ...
        <div className="xl:col-span-8 space-y-8">
            ...
            <div className="w-full lg:w-[42%] relative flex items-center justify-center">
              <div className="relative z-10 w-full flex items-center justify-center">
                <div className="rounded-3xl p-8 text-center gradient-accent" style={{ border: "1px solid rgba(53,37,205,0.1)" }}>
                  ...
                  <div className="font-bold text-sm" style={{ color: "#3525cd", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    Nexus Institute
                  </div>
                  ...
                  <div className="mt-4">
                    <div className="flex justify-between text-xs mb-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      ...
                      <span style={{ color: "#3B82F6", fontWeight: 700 }}>{displayXP.toLocaleString()} / {displayXPToNext.toLocaleString()} XP</span>
                    </div>
            ...
            <div className="rounded-[24px] p-6 space-y-6 glass">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm font-bold">
                  ...
                  <span style={{ color: "#3525cd" }}>68%</span>
                </div>
                <div className="h-2 w-full rounded-full overflow-hidden" style={{ background: "#eceef0" }}>
                  <div className="h-full rounded-full" style={{ width: "68%", background: "#3525cd" }} />
                </div>
              </div>

              <button className="w-full py-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-colors hover:opacity-90" style={{ background: "rgba(53,37,205,0.06)", color: "#3525cd", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          ...
          <section className="space-y-5">
            ...
            <div className="space-y-3">
              <div className="rounded-2xl p-4 flex items-center gap-4" style={{ background: "rgba(53,37,205,0.05)", backdropFilter: "blur(12px)", border: "1px solid rgba(53,37,205,0.25)" }}>
                <div className="w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold flex-shrink-0" style={{ background: "rgba(53,37,205,0.12)", color: "#3525cd" }}>
                  <CheckCircle2 className="w-5 h-5" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-sm text-[#191c1e] truncate" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    Módulo 3: Introducción al ML
                  </div>
                  <div className="text-xs text-[#464555] mt-0.5">10 lecciones</div>
                </div>
                <span className="text-xs font-bold px-3 py-1 rounded-full flex-shrink-0" style={{ background: "rgba(53,37,205,0.1)", color: "#3525cd", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  En curso
                </span>
          ...
          <section className="space-y-5">
            <div className="flex justify-between items-end">
              ...
              <a href="#" className="text-sm font-bold flex items-center gap-1 hover:underline" style={{ color: "#3525cd", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Ver todos <ChevronRight className="w-3.5 h-3.5" />
              </a>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="rounded-[20px] p-4 text-center space-y-4 transition-transform cursor-pointer glass" style={{ opacity: "0.5" }}>
                ...
                <div className="h-1.5 rounded-full overflow-hidden" style={{ background: "#eceef0" }}>
                  <div className="h-full rounded-full" style={{ width: "0%", background: "#9ca3af" }}></div>
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="xl:col-span-4 space-y-8">
          ...
          <section className="rounded-[32px] p-6 space-y-6 glass">
            <div className="flex justify-between items-center">
              ...
              <a href="#" className="text-xs font-bold flex items-center gap-1 hover:underline" style={{ color: "#3525cd", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
              ...
              <div className="text-center">
                ...
                <div className="relative w-24 h-24 mx-auto mb-3">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-2xl font-bold" style={{ color: "#3525cd", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      4
                    </span>
                  </div>
                </div>
                <p className="font-bold text-sm" style={{ color: "#3525cd", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  Investigador
                </p>
            ...
            <div className="space-y-3">
              {levels.map((lv) => (
                <div key={lv.label} className={`flex items-center gap-4 p-2.5 rounded-xl transition-opacity ${lv.locked ? "opacity-40" : lv.active ? "" : "opacity-75 hover:opacity-100"}`} style={lv.active ? { background: "rgba(53,37,205,0.06)", border: "1px solid rgba(53,37,205,0.2)", borderRadius: "12px" } : {}}>
                  <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style={lv.done ? { background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.3)", color: "#10B981" } : lv.active ? { background: "rgba(53,37,205,0.15)", border: "1px solid rgba(53,37,205,0.4)", color: "#3525cd" } : { background: "#eceef0", color: "#777587" }}>
                    {lv.done ? (
                  ...
                  <span className="text-sm flex-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: lv.active ? 700 : 500, color: lv.active ? "#3525cd" : "#191c1e" }}>
                    {lv.label}
                  </span>
                  {lv.done && (
                  ...
                  {lv.active && (
                    <Rocket className="w-4 h-4 flex-shrink-0" style={{ color: "#3525cd" }} />
                  )}
                </div>
              ))}
            </div>
          ...
          <section className="rounded-[32px] p-6 space-y-5 glass">
            <div className="flex justify-between items-center">
              ...
              <a href="#" className="text-xs font-bold hover:underline" style={{ color: "#3525cd", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Ver todos
              </a>
            </div>
      ...
      <section className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="rounded-2xl p-4 flex items-start gap-4 glass">
            <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: "rgba(59,130,246,0.1)", color: "#3B82F6" }}>
            ...
            <div>
              ...
              <p className="text-xs text-[#464555] mt-0.5 mb-2">"Excelente enfoque en el Lab de Python..."</p>
              <span className="text-[10px] text-[#46455580]">Hace 5 min</span>
            </div>
          </div>
        </div>
      </section>

      {/* ACTIVITY BAR GO HERE — placeholder */}
      <section className="rounded-3xl p-6 flex flex-col md:flex-row items-center justify-between gap-5 overflow-hidden relative glass">
        <div className="absolute left-0 top-0 w-1.5 h-full rounded-l-3xl" style={{ background: "#3B82F6" }}></div>
        ...
        <div className="flex items-center gap-10">
          <div className="text-center">
            ...
            <p className="font-extrabold" style={{ color: "#10B981", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
              +30 XP
            </p>
          </div>
          <div className="text-center">
