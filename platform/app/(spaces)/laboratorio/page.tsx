...
export const metadata: Metadata = {
  title: "Laboratorio",
  description: "Laboratorio interactivo de ML: experimenta con código, notebooks y modelos directamente en el navegador.",
}
...
export default function LaboratorioPage() {
  return (
    <div className="space-y-8">
      ...
      {/* Mock Editor */}
      <section className="bg-gray-800 rounded-lg border border-gray-700 p-8" aria-label="Editor de código de ejemplo">
        <div className="text-center">
          <div className="w-20 h-20 bg-gradient-to-r from-green-500 to-teal-500 rounded-lg mx-auto mb-4 flex items-center justify-center text-white text-3xl" aria-hidden="true">
            🧪
          </div>
          ...
          {/* Mock Code Editor */}
          <div className="bg-black rounded-lg p-6 font-mono text-left max-w-2xl mx-auto" role="region" aria-label="Editor de código de muestra">
            <div className="flex items-center space-x-2 mb-4" aria-hidden="true">
              <div className="w-3 h-3 bg-red-500 rounded-full"></div>
              <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
              <div className="w-3 h-3 bg-green-500 rounded-full"></div>
            </div>
            <div className="space-y-2" aria-label="Código de ejemplo: red neuronal con PyTorch">
              <div>
          ...
          <button className="mt-6 bg-gradient-to-r from-green-500 to-teal-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-green-600 hover:to-teal-700 transition-all" aria-label="Abrir notebook de ejemplo">
            🧪 Abrir Notebook
          </button>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg mb-3 flex items-center justify-center text-white" aria-hidden="true">
            ⚡
          </div>
          <h2 className="text-lg font-semibold mb-2">Ejecución Rápida</h2>
          <p className="text-gray-300 text-sm">Papers notebooks con kernels de GPU acceleration</p>
        </div>
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg mb-3 flex items-center justify-center text-white" aria-hidden="true">
            🔬
          </div>
          <h2 className="text-lg font-semibold mb-2">Edición Colaborativa</h2>
