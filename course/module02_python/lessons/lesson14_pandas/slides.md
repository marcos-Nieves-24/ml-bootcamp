...
## Diapositiva 3: Pandas Data Structures
...
## Diapositiva 4: Creating DataFrames
```python
...
## Diapositiva 9: Merging DataFrames
```python
...
## Diapositiva 10: Apply Functions
```python
...
## Diapositiva 11: Handling Missing Data
```python
