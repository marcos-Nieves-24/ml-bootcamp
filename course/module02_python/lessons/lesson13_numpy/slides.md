...
## Diapositiva 5: Array Attributes
```python
...
## Diapositiva 6: Indexing and Slicing
```python
arr[0, 1]       # Element
arr[1]          # Row
arr[:, 1]       # Column
...
## Diapositiva 7: Universal Functions
```python
...
## Diapositiva 11: Statistical Operations
```python
arr.sum() / .mean() / .std()
arr.min() / .max()
arr.cumsum()
