...
## Diapositiva 2: Why Variables Matter
...
## Diapositiva 3: What is a Variable?
- Named memory location storing a value
- Like a labeled box
- `temperature = 36.6`
- Can hold any type of data

## Diapositiva 4: Variable Assignment
```python
x = 5
name = "Alice"
pi = 3.14159
...
## Diapositiva 7: Good vs Bad Names
| Good | Bad |
|------|-----|
| `gene_expression` | `ge` |
| `customer_count` | `cc` |
...
## Diapositiva 9: Multiple Assignment
```python
a, b, c = 1, 2, 3
x = y = z = 0  # same value
a, b = b, a    # swap
...
## Diapositiva 10: Input and Output
```python
print("Hello")
