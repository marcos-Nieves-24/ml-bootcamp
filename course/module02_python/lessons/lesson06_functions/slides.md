...
## Diapositiva 2: Why Functions?
- Reusable code blocks
- DRY: Don't Repeat Yourself
- Modular, testable programs
- Encapsulate logic

## Diapositiva 3: Function Anatomy
```python
...
## Diapositiva 9: Lambda Functions
...
## Diapositiva 10: Docstrings (PEP 257)
```python
