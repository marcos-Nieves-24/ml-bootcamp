...
## Diapositiva 5: Random Forest = Bagging + Feature Randomness
...
## Diapositiva 10: Demo — Tree vs. Forest
- Breast cancer dataset
- Single tree: ~93% test
- Random Forest: ~97% test
- OOB: ~95% (close to test)

## Diapositiva 11: Demo — n_estimators Effect
