...
## Diapositiva 6: MAE (Mean Absolute Error)
- MAE = (1/n) Σ |y - ŷ|
- Average absolute error
- In original units
- Interpretable

## Diapositiva 7: MSE and RMSE
- MSE = (1/n) Σ (y - ŷ)²
- Penalizes large errors more
- RMSE = √MSE (in original units)
- RMSE ≥ MAE (always)

## Diapositiva 8: R² (Coefficient of Determination)
- R² = 1 - SSE / SST
- Proportion of variance explained
- 1 = perfect, 0 = mean predictor
- Can be negative (worse than mean)

## Diapositiva 9: Overfitting Detection
- Train R² >> Test R²
